...
try:
    ...
    from services.bookoasis_db import resolve_engine
    from services.kavita_migration import parse_mapping_lines
    ...
    def __init__(
        ...
        if self.database_settings and resolve_engine(self.database_settings) == "mariadb":
            try:
                ...
                from services.mariadb_package import MariaDBPackageEngine
