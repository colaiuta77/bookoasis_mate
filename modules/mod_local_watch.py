...
from ..clients.bookoasis_client import BookOasisClient
from ..services.discord_notifier import DiscordWebhookNotifier
from ..services.gdrive_scan import GDriveScanProcessor, map_path, parse_path_mappings, parse_extensions, validate_event
from ..services.local_folder_watch import overlaps, validate_roots
from ..setup import *
    ...
    def start(self, reset=False):
        with self._lock:
            ...
            self._process = subprocess.Popen(
                [sys.executable, "-u", os.path.join(os.path.dirname(os.path.dirname(__file__)), "services", "local_folder_watch.py")],
