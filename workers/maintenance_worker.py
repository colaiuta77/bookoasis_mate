...
try:
    ...
    from ..services.category_migration import CategoryMigrationEngine, MigrationStopped
    from ..services.cover_inspector import cleanup_orphan_files, inspect_cover_file
    from ..services.library_statistics import LibraryStatisticsCancelled, LibraryStatisticsEngine
    from ..services.mate_engine import BookOasisMateEngine
except ImportError:
    from clients.bookoasis_client import BookOasisClient
    from services.bookoasis_db import BookOasisDatabaseAdapter
    from services.category_migration import CategoryMigrationEngine, MigrationStopped
